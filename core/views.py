        ...
        try:
            ...
            if form.is_valid():
                ...
                if use_default_shipping:
                    ...
                    print("User is entering the new shipping address")
                ...
                if same_billing_address:
                    ...
                    print("User is entering the new billing address")
...
def add_to_cart(request, slug):
    ...
    if order_qs.exists():
        ...
        if order.items.filter(item__slug=item.slug).exists():
            ...
            order_item.save()
            messages.info(request, "Item Quantity was updated in your cart.")
            return redirect("core:order-summary")
        else:
...
def get_coupon_code(request, code):
    try:
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            try:
                ...
                order.coupon = get_coupon_code(self.request, code)
                order.save()
                messages.info(self.request, "Coupon applied")
                return redirect("core:checkout")
            except ObjectDoesNotExist:
                messages.warning(
